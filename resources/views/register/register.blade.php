            ...
            <div class="row">
                <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
                    <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
                        ...
                        <img class="img-fluid rounded mx-auto my-4" loading="lazy"
                            src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.pngkey.com%2Fdetail%2Fu2w7w7u2t4a9y3r5_register-user-register-online-icon-png%2F&psig=AOvVaw0iF4DMfwEFWWAuqsAx1MNy&ust=1715226809756000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCIC1pKia_YUDFQAAAAAdAAAAABAE"
                            {{-- src="./assets/img/bsb-logo.svg" --}} width="245" height="80" alt="BootstrapBrain Logo">
                ...
                <div class="col-12 col-md-6 bsb-tpl-bg-lotion">
                    <div class="p-3 p-md-4 p-xl-5">
                        ...
                        <form action="{{ route('actionRegisterProjectAndUser') }}" method="POST"
                            ...
                            <div class="row gy-3 gy-md-4 overflow-hidden">
                                ...
                                <div class="col-12">
                                    <label>Address</label>
                                    <textarea class="form-control" name="address" id="address" rows="4" placeholder="Jalan.."></textarea>
                                </div>
